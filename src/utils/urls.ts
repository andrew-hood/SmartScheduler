...
export const GO1_AUTH_URL = "https://auth.qa.go1.cloud";

export const GO1_API_V2_URL = "https://public.qa.go1.cloud/v2";

export const GO1_API_V3_URL = "https://gateway.qa.go1.cloud";
